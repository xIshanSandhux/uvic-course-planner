...
export default function Dashboard() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 pt-10 overflow-x-hidden text-purple">
      {/* Header */}
      <div className="mb-6">
        ...
        <div className="bg-white rounded shadow p-4 space-y-1 text-sm">
          ...
          <div className="flex gap-3 mt-3">
            <button
              ...
              onClick={() => navigate('/form/plan')}
            >
              Edit Plan
            </button>
            <button className="text-sm border border-purple text-purple px-3 py-1 rounded">
              Launch Chat
            </button>
            <button className="text-sm border border-purple text-purple px-3 py-1 rounded">
              Export PDF
        ...
        <div className="bg-white rounded shadow divide-y">
          {[
            ...
            >
              ...
              <button className="text-purple underline text-sm">
                View Chat
              </button>
            </div>
          ))}
